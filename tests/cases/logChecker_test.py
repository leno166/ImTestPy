...
def DmzFilterParser_test():
    ...
    with open(r'D:\workflow\ImTestPy\tests\data\dmz_log_temp\dmz_filter.log.2025-12-08_17_20_29.305614398', 'r', encoding='utf-8') as f:
...
def DmzRecorderForeverParser_test():
    dmz_filter_parser = DmzRecorderParser()
    with open(r'D:\workflow\ImTestPy\tests\data\dmz_log_temp\dmz_recorder_forever.log.2025-12-08_17_20_29.263278583', 'r',
              encoding='utf-8') as f:
        for l in dmz_filter_parser.read(f):
            assert len(l.level) == 3
            assert l.run_time is not None
